...
public class SingletonPatternSample {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("Bill Pugh Singleton or Holder Singleton sample:");
        billPughSingleton();
        System.out.println("------------------------------------------------");
        ...
        System.out.println("Tóm lại nếu muốn khởi tạo lazy mà an toàn trong đa luồng thì sử dụng Holder Singleton, nếu " +
